...
const art = `<g fill="none" stroke="#C06A12" stroke-width="3">
  ...
  <circle cx="32" cy="32" r="7" fill="#10756B"/>`;

const plain = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <rect width="64" height="64" rx="14" fill="#F6F3EC"/>
  ${art}
</svg>`;
...
const maskable = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <rect width="64" height="64" fill="#F6F3EC"/>
