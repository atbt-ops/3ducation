...
const plain = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <rect width="64" height="64" rx="14" fill="#EDE7D9"/>
  <g fill="none" stroke="#A9762E" stroke-width="3">
  ...
  <circle cx="32" cy="32" r="7" fill="#2C6E6B"/>
</svg>`;
...
const maskable = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <rect width="64" height="64" fill="#EDE7D9"/>
